...
/* AI 가 못하는 걸 해야 한다!
1. 문제 정의와 설계
- AI는 코드 구현을 잘하지만, 무엇을 만들지, 왜 만드는지 어떤 구조로 만들 것인지에 대한 판단을 못함
2. 협업, 커뮤니케이션 능력
-AI 는 협업 X ,문제에 대한 맥락 설명, 이해가 어려움
3. 실무적 감각
-성능/효율 개선을 위한 코드 작성 능력 약함
[AI 잘 쓰자]
1. AI가 생성한 코드.답안은 "가능한 답/학습된 답" 중 하나를 제시 -> 무조건 신뢰 X ,꼭 분석/확인 필요
 */